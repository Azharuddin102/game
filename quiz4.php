...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q4']=$q4;
    header("location: http://localhost/html/quiz5.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz5.php" />
  ...
  <body>
          ...
          <h2 id="test_status"> Question 4 of 10</h2>
          <div id="test"><h2> Q4.what is the full form of PHP?</h2>
            <form action="http://localhost/html/quiz4.php" method="post">
              <div id="option">
                  <input type="radio" name="choice" value="A" />Pull section patna<br/>
                  <input type="radio" name="choice" value="B" />Power station Park<br/>
                  <input type="radio" name="choice" value="C" />Personal Home Page<br/>
                  <input type="radio" name="choice" value="D" />POWER OF section patna<br/><br/>
              </div>
              <div>
