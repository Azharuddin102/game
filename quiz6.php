...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q6']=$q6;
    header("location: http://localhost/html/quiz7.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz7.php" />
  ...
  <body>
          ...
          <h2 id="test_status"> Question 6 of 10</h2>
          <div id="test"><h2> Q6.what is the full form of ATM?</h2>
            <form action="http://localhost/html/quiz6.php" method="post">
              <div id="option">
