...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q8']=$q8;
    header("location: http://localhost/html/quiz9.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz9.php" />
  ...
  <body>
          <div class="timecounter">
            <script type="text/javascript">
              function countDown(secs,elem)
              {
                ...
                if(secs < 1){
                  clearTimeout(timer);
                  element.innerHTML='<br><h1 style="color:black">TEST LOADED</h1>';
          ...
          <h2 id="test_status"> Question 8 of 10</h2>
          <div id="test"><h2> Q8.what is the full form of ATM?</h2>
            <form action="http://localhost/html/quiz8.php" method="post">
              <div id="option">
                  <input type="radio" name="choice" value="A" />Automatic Trailor Machine<br/>
                  <input type="radio" name="choice" value="B" />Automatic Transfer Money<br/>
                  <input type="radio" name="choice" value="C" />Any Time Money<br/>
