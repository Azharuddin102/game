...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q2']=$q2;
    header("location: http://localhost/html/quiz3.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz3.php" />
  ...
  <body>
          ...
          <h2 id="test_status"> Question 2 of 10</h2>
          <div id="test"><h2> Q2.what is the full form of HTML?</h2>
            <form action="http://localhost/html/quiz2.php" method="post">
              <div id="option">
                  <input type="radio" name="choice" value="A" />Hyper text making link<br/>
                  <input type="radio" name="choice" value="B" />Hyper text markup language<br/>
                  <input type="radio" name="choice" value="C" />Hyper text making language<br/>
                  <input type="radio" name="choice" value="D" />Hyper text markup link<br/><br/>
              </div>
              <div>
