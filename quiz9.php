...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q9']=$q9;
    header("location: http://localhost/html/quiz10.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz10.php" />
  ...
  <body>
          ...
          <h2 id="test_status"> Question 9 of 10</h2>
          <div id="test"><h2> Q9.what is the full form of GK?</h2>
            <form action="http://localhost/html/quiz9.php" method="post">
              <div id="option">
                  <input type="radio" name="choice" value="A" />genral knowledge<br/>
                  <input type="radio" name="choice" value="B" />gk<br/>
                  <input type="radio" name="choice" value="C" />gulshan kumar<br/>
