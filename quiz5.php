...
if (isset($_POST['submit']))
{
    ...
    echo "string";
    $_SESSION['q5']=$q5;
    header("location: http://localhost/html/quiz6.php");
}
?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <meta http-equiv="refresh" content="30;URL=http://localhost/html/quiz6.php" />
  ...
  <body>
          ...
          <h2 id="test_status"> Question 5 of 10</h2>
          <div id="test"><h2> Q5.what is the full form of WWW?</h2>
            <form action="http://localhost/html/quiz5.php" method="post">
              <div id="option">
                  <input type="radio" name="choice" value="A" />World wide web<br/>
                  <input type="radio" name="choice" value="B" />World WIDE banking<br/>
                  <input type="radio" name="choice" value="C" />working wide webs<br/>
                  <input type="radio" name="choice" value="D" />none of these<br/><br/>
              </div>
              <div>
